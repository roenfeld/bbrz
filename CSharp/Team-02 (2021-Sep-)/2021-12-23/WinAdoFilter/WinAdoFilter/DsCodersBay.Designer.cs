...
namespace WinAdoFilter.DsCodersBayTableAdapters {
    ...
    public partial class countriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[countries] SET [country_id] = @country_id, [country_name] = @countr" +
                "y_name, [region_id] = @region_id WHERE (([country_id] = @Original_country_id));\r" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinAdoFilter.Properties.Settings.Default.CodersBayConnectionString;
        }
    ...
    public partial class regionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[regions] WHERE (([region_id] = @Original_region_id))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[regions] SET [region_name] = @region_name WHERE (([region_id] = @Or" +
        ...
        public virtual int Update(string region_name, int Original_region_id, int region_id) {
            if ((region_name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string region_name, int Original_region_id) {
            return this.Update(region_name, Original_region_id, Original_region_id);
        }
    }

...
namespace WinOOP1
{
  public partial class FrmMain : Form
  {
    public FrmMain()
    {
      ...
      var marken = Auto.GetMarken();
      //marken = Auto.Marken;

      var typen = Auto.GetTypen("Opel");

      this.MeinAuto = new Auto("BMW", "320");
      ...
      int x = Login.MaxPwdLen;
      Login.MinPwdLen = 12;

      var lo = new Login() { UserName = "Max" };
    ...
    {      
      this.MeinAuto.Fahren(100.3);
      this.MeinAuto.Fahren(100, 6);
